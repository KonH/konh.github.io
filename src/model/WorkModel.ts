    ...
    return [
      {
        ...
        current: true,
        bullets: [
          "Project: Homescapes, 600M+ installs",
          "Developed 11 game features (8 of them multiplayer-based) as a member of 4 feature teams",
          "Developed core gameplay systems in C++, including player clans rework",
          "Prototyped new gameplay and UI features and adapted existing features to Homescapes from other Playrix projects",
          ...
          "Implemented ECS engine migration, improving architecture and performance, leads up to 21-40% shorter frame time",
